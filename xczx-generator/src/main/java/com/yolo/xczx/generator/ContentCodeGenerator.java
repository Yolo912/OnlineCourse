package com.yolo.xczx.generator;
...
//			"course_category"
	...
	public static void main(String[] args) {
		...
		//生成路径
		gc.setOutputDir(System.getProperty("user.dir") + "/xczx-generator/src/main/java");
		gc.setAuthor("itcast");
		gc.setOpen(false);
		...
		dsc.setUrl("jdbc:mysql://localhost:3306/xczx_" + SERVICE_NAME
